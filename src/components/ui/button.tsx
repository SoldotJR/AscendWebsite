  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-full text-sm font-semibold transition-all duration-300 focus-ring disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        ...
        secondary:
          "bg-surface text-foreground border border-border hover:-translate-y-0.5 hover:border-royal/40",
        outline:
          "border border-border bg-transparent text-foreground hover:bg-surface-muted",
        ghost: "hover:bg-surface-muted text-foreground",
        gold: "bg-accent-gold text-[#0B1220] hover:-translate-y-0.5 hover:opacity-95",
        link: "rounded-none text-royal underline-offset-4 hover:underline px-0",
      },
      size: {
        default: "h-11 px-6",
        sm: "h-9 px-4 text-xs",
